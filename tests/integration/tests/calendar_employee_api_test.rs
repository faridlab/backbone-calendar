//! CalendarEmployee API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the CalendarEmployee CRUD API endpoints.
...
// ============================================================================
// CALENDAREMPLOYEE TEST DATA GENERATOR
// ============================================================================

/// Test data generator for CalendarEmployee
pub struct CalendarEmployeeTestData;

impl TestDataGenerator for CalendarEmployeeTestData {
...
// ============================================================================
// CALENDAREMPLOYEE API TEST
// ============================================================================

/// CalendarEmployee API test suite
pub struct CalendarEmployeeApiTest {
    inner: GenericCrudTest<CalendarEmployeeTestData>,
}

impl CalendarEmployeeApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/calendar_employees", "CalendarEmployee");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, CalendarEmployeeTestData),
        }
    }
...
impl Default for CalendarEmployeeApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_calendar_employee_crud() {
...
// <<< CUSTOM TESTS START >>>
// Add CalendarEmployee specific tests here
// <<< CUSTOM TESTS END >>>
