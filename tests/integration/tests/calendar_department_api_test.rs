//! CalendarDepartment API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the CalendarDepartment CRUD API endpoints.
...
// ============================================================================
// CALENDARDEPARTMENT TEST DATA GENERATOR
// ============================================================================

/// Test data generator for CalendarDepartment
pub struct CalendarDepartmentTestData;

impl TestDataGenerator for CalendarDepartmentTestData {
...
// ============================================================================
// CALENDARDEPARTMENT API TEST
// ============================================================================

/// CalendarDepartment API test suite
pub struct CalendarDepartmentApiTest {
    inner: GenericCrudTest<CalendarDepartmentTestData>,
}

impl CalendarDepartmentApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/calendar_departments", "CalendarDepartment");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, CalendarDepartmentTestData),
        }
    }
...
impl Default for CalendarDepartmentApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_calendar_department_crud() {
...
// <<< CUSTOM TESTS START >>>
// Add CalendarDepartment specific tests here
// <<< CUSTOM TESTS END >>>
