//! Specifications for CalendarBranch aggregate
//!
...
// Each predicate implements `Specification<CalendarBranch>` and can be combined
...
//
// pub struct ActiveCalendarBranchSpec;
// impl Specification<CalendarBranch> for ActiveCalendarBranchSpec {
//     fn is_satisfied_by(&self, e: &CalendarBranch) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
