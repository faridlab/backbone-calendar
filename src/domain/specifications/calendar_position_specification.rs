//! Specifications for CalendarPosition aggregate
//!
...
// Each predicate implements `Specification<CalendarPosition>` and can be combined
...
//
// pub struct ActiveCalendarPositionSpec;
// impl Specification<CalendarPosition> for ActiveCalendarPositionSpec {
//     fn is_satisfied_by(&self, e: &CalendarPosition) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
