//! Specifications for CalendarEvent aggregate
//!
...
// Each predicate implements `Specification<CalendarEvent>` and can be combined
...
//
// pub struct ActiveCalendarEventSpec;
// impl Specification<CalendarEvent> for ActiveCalendarEventSpec {
