//! Specifications for CalendarEmployee aggregate
//!
...
// Each predicate implements `Specification<CalendarEmployee>` and can be combined
...
//
// pub struct ActiveCalendarEmployeeSpec;
// impl Specification<CalendarEmployee> for ActiveCalendarEmployeeSpec {
//     fn is_satisfied_by(&self, e: &CalendarEmployee) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
