//! Specifications for CalendarReligion aggregate
//!
...
// Each predicate implements `Specification<CalendarReligion>` and can be combined
...
//
// pub struct ActiveCalendarReligionSpec;
// impl Specification<CalendarReligion> for ActiveCalendarReligionSpec {
//     fn is_satisfied_by(&self, e: &CalendarReligion) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
