//! Specifications for CalendarEventSeries aggregate
//!
...
// Each predicate implements `Specification<CalendarEventSeries>` and can be combined
...
//
// pub struct ActiveCalendarEventSeriesSpec;
// impl Specification<CalendarEventSeries> for ActiveCalendarEventSeriesSpec {
//     fn is_satisfied_by(&self, e: &CalendarEventSeries) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
