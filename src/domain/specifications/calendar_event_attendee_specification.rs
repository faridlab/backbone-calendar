//! Specifications for CalendarEventAttendee aggregate
//!
...
// Each predicate implements `Specification<CalendarEventAttendee>` and can be combined
...
//
// pub struct ActiveCalendarEventAttendeeSpec;
// impl Specification<CalendarEventAttendee> for ActiveCalendarEventAttendeeSpec {
//     fn is_satisfied_by(&self, e: &CalendarEventAttendee) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
