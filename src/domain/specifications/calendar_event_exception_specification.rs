//! Specifications for CalendarEventException aggregate
//!
...
// Each predicate implements `Specification<CalendarEventException>` and can be combined
...
//
// pub struct ActiveCalendarEventExceptionSpec;
// impl Specification<CalendarEventException> for ActiveCalendarEventExceptionSpec {
//     fn is_satisfied_by(&self, e: &CalendarEventException) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
