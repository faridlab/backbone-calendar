//! Domain policy for CalendarEventException aggregate
//!
...
/// Domain policy for CalendarEventException — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<CalendarEventException>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type CalendarEventExceptionDomainPolicy = PermitAllPolicy<CalendarEventException>;
