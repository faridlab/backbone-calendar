//! Repository for CalendarEventSeries entities
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Thin newtype over `backbone_orm::GenericCrudRepository<CalendarEventSeries, backbone_orm::SoftDelete>`.
...
/// Table name for CalendarEventSeries entities
pub const TABLE_NAME: &str = "calendar.event_series";

/// Repository for CalendarEventSeries entities.
///
/// All standard CRUD, soft-delete, pagination, and bulk methods are
/// provided automatically via `Deref` to `backbone_orm::GenericCrudRepository`.
pub struct CalendarEventSeriesRepository(
