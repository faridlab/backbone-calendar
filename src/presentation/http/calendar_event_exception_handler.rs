//! CalendarEventException REST handlers
//!
...
pub enum CalendarEventExceptionError {
    #[error("Not found: {0}")]
    NotFound(String),
...
impl From<ServiceError> for CalendarEventExceptionError {
...
impl axum::response::IntoResponse for CalendarEventExceptionError {
...
/// Create Axum router with all 16 Backbone endpoints for CalendarEventException.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /calendar_event_exceptions | List with pagination |
/// | POST | /calendar_event_exceptions | Create new |
/// | GET | /calendar_event_exceptions/:id | Get by ID |
/// | PUT | /calendar_event_exceptions/:id | Full update |
/// | PATCH | /calendar_event_exceptions/:id | Partial update |
/// | DELETE | /calendar_event_exceptions/:id | Soft delete |
/// | POST | /calendar_event_exceptions/bulk | Bulk create |
/// | POST | /calendar_event_exceptions/upsert | Upsert |
/// | GET | /calendar_event_exceptions/trash | List deleted |
/// | POST | /calendar_event_exceptions/:id/restore | Restore |
/// | DELETE | /calendar_event_exceptions/empty | Empty trash |
/// | GET | /calendar_event_exceptions/:id/deleted | Get deleted by ID |
/// | DELETE | /calendar_event_exceptions/trash/:id | Permanent delete from trash |
/// | GET | /calendar_event_exceptions/count | Count active entities |
/// | GET | /calendar_event_exceptions/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
