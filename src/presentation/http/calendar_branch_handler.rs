...
impl From<ServiceError> for CalendarBranchError {
...
impl axum::response::IntoResponse for CalendarBranchError {
...
/// Create Axum router with all 16 Backbone endpoints for CalendarBranch.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /calendar_branches | List with pagination |
/// | POST | /calendar_branches | Create new |
/// | GET | /calendar_branches/:id | Get by ID |
/// | PUT | /calendar_branches/:id | Full update |
/// | PATCH | /calendar_branches/:id | Partial update |
/// | DELETE | /calendar_branches/:id | Soft delete |
/// | POST | /calendar_branches/bulk | Bulk create |
/// | POST | /calendar_branches/upsert | Upsert |
/// | GET | /calendar_branches/trash | List deleted |
/// | POST | /calendar_branches/:id/restore | Restore |
/// | DELETE | /calendar_branches/empty | Empty trash |
/// | GET | /calendar_branches/:id/deleted | Get deleted by ID |
/// | DELETE | /calendar_branches/trash/:id | Permanent delete from trash |
/// | GET | /calendar_branches/count | Count active entities |
/// | GET | /calendar_branches/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
/// let service = Arc::new(CalendarBranchService::with_repository(repository));
...
#[cfg(feature = "auth")]
pub fn create_protected_calendar_branch_routes<A: AuthMiddleware + Send + Sync + 'static>(
    service: Arc<CalendarBranchService>,
    auth: Arc<A>,
) -> Router {
    use axum::middleware;
